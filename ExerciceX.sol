...
contract ExerciceX{
    ...
    function claimToken(bytes32 _blockhash, uint _blockNumer, uint _chainId) public {
        require(userValided[msg.sender] == false, "you have already claim");
        require(_blockNumer >= block.number + 10, "The block is not the range");
        require(blockhash(_blockNumer) == _blockhash, "Wrong blockhash");
